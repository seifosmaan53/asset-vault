...
export class CreateInventoryItemDto {
  ...
  @ApiPropertyOptional({ example: 10.5, description: 'Cost price per unit' })
  @IsOptional()
  @IsNumber()
  costPrice?: number;
  ...
  @ApiPropertyOptional({
    example: 0.15,
    description: 'Default tax rate (e.g., 0.15 for 15%)',
  })
  @IsOptional()
  @IsNumber()
...
export class CreateStockMovementDto {
  ...
  @ApiProperty({
    example: 50,
    description:
      'Quantity of items moved (positive for purchase, negative for sale)',
  })
  @IsNumber()
  quantity: number;
  ...
  @ApiPropertyOptional({
    ...
    description: 'ID of the source (e.g., invoice ID)',
  })
  @IsOptional()
  @IsString()
  sourceId?: string;
