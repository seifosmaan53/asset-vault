...
export class CreateStoreItemSettingsDto {
  ...
  @ApiPropertyOptional({
    example: 100,
    description: 'Current stock quantity for this item at this store',
    minimum: 0,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    example: 200,
    description: 'Target stock quantity for this item at this store',
    minimum: 0,
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    example: 25,
    description: 'Average weekly usage of this item at this store',
    minimum: 0,
  })
  @IsOptional()
  @IsNumber()
