 ...
 */
export class AddUserIdAndOrganizationIdIndexes1751000000000
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_stock_movements_org_inventoryItem_createdAt";`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_user_settings_organizationId_userId";`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_inventory_items_organizationId_userId";`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_clients_organizationId_userId";`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_invoices_organizationId_userId";`,
    );

    // Remove legacy NULL-org partial indexes
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_inventory_items_userId_orgId_null";`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_clients_userId_orgId_null";`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_invoices_userId_orgId_null";`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "IDX_stores_organizationId";`,
    );
