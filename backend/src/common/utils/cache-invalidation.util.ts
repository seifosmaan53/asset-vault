...
export const CACHE_INVALIDATION_RULES: Record<string, CacheInvalidationRule> = {
  ...
  invoice: {
    invalidateOnCreate: [
      CacheKey.INVOICES_LIST,
      CacheKey.INVOICE_STATS,
      CacheKey.ANALYTICS_REVENUE,
    ],
    invalidateOnUpdate: [
      CacheKey.INVOICES_LIST,
      CacheKey.INVOICE_DETAIL,
      CacheKey.INVOICE_STATS,
      CacheKey.ANALYTICS_REVENUE,
    ],
    invalidateOnDelete: [
  ...
  inventory: {
    ...
    invalidateOnUpdate: [
      ...
      CacheKey.INVENTORY_DETAIL,
      CacheKey.INVENTORY_STATS,
      CacheKey.LOW_STOCK,
      CacheKey.STORE_STOCK,
    ],
    invalidateOnDelete: [
      CacheKey.INVENTORY_LIST,
      CacheKey.INVENTORY_DETAIL,
  ...
  store: {
    ...
    invalidateOnUpdate: [
      ...
      CacheKey.STORE_DETAIL,
      CacheKey.STORE_STOCK,
      CacheKey.ANALYTICS_STORE,
    ],
    invalidateOnDelete: [
      CacheKey.STORES_LIST,
      CacheKey.STORE_DETAIL,
