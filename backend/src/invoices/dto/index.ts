...
export class InvoiceItemDto {
  ...
  @ApiPropertyOptional({
    example: 100.0,
    description: 'Line total (calculated by backend)',
  })
  @IsOptional()
  @IsNumber()
  lineTotal?: number;
...
export class CreateInvoiceDto {
  ...
  @ApiProperty({
    example: '2024-01-15',
    description: 'Invoice issue date (ISO date string)',
  })
  @IsDateString()
  issueDate: string;
  ...
  @ApiPropertyOptional({
    example: '2024-02-15',
    description: 'Invoice due date (ISO date string)',
  })
  @IsOptional()
  @IsDateString()
  dueDate?: string;
...
export class UpdateInvoiceDto {
  ...
  @IsDateString(
    ...
    {
      message:
        'Issue date must be a valid date string in ISO format (YYYY-MM-DD)',
    },
  )
  issueDate?: string;
  ...
  @IsDateString(
    ...
    {
      message:
        'Due date must be a valid date string in ISO format (YYYY-MM-DD)',
    },
  )
  dueDate?: string;
