...
export class InvoiceFiltersDto {
  ...
  @ApiPropertyOptional({
    description: 'Search by invoice number, client name, email, etc.',
  })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({
    description: 'Filter by issue date from (ISO date string)',
  })
  @IsOptional()
  @IsDateString()
  ...
  @ApiPropertyOptional({
    description: 'Filter by issue date to (ISO date string)',
  })
  @IsOptional()
  @IsDateString()
  issueDateTo?: string;
  ...
  @ApiPropertyOptional({
    description: 'Filter by paid date from (ISO date string)',
  })
  @IsOptional()
  @IsDateString()
  paidDateFrom?: string;
  ...
  @ApiPropertyOptional({
    description: 'Filter by paid date to (ISO date string)',
  })
  @IsOptional()
  @IsDateString()
  paidDateTo?: string;
