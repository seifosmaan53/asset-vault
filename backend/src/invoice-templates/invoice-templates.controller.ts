...
export class InvoiceTemplatesController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve the default invoice template for the authenticated user.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Retrieve a specific invoice template by its ID.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Create a new customizable invoice template.',
  })
